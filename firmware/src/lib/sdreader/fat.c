...
MSG_DEC("h-read-from ", (partition_offset + 0x0b));
MSG_DEC("h-read-size ", sizeof(buffer));
...
MSG_DEC("h-sectors-count ", sector_count);	 
#if FAT_FAT32_SUPPORT
